<html>
    <head>
        ...
        <style type="text/css">#icheckForm .radio, #icheckForm .checkbox {padding-left: 0;}</style>
            ...
            <form id="icheckForm" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-lg-3 control-label">Job position</label>
                            ...
                            <div class="col-lg-5">
                                <div class="radio">
                                    <label><input type="radio" name="job" value="designer" /> Designer</label>
                                </div>

                                <div class="radio">
                                    <label><input type="radio" name="job" value="frontend" /> Front-end Developer</label>
                                </div>

                                <div class="radio">
                                    <label><input type="radio" name="job" value="backend" /> Back-end Developer</label>
                                </div>

                                <div class="radio">
                                    <label><input type="radio" name="job" value="dba" /> Database Administrator</label>
                                </div>

                                <div class="radio">
                                    <label><input type="radio" name="job" value="sys" /> System Engineer</label>
                                </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Programming Languages</label>
                                <div class="col-lg-5">
                                    ...
                                    <div class="checkbox">
                                        <label><input type="checkbox" name="languages[]" value="c" /> C/C++</label>
                                    </div>
